########################################################
# Routing Connection Matrices for USER PERSONA: NURSE
# 
# Purpose: Allow the nurse role to easily analyze data 
...
# Create a new Blueprint object for the Nurse User Persona
# Allows for a variable to store a collection of routes.
nurse = Blueprint('nurse', __name__)

#--------------------[Nurse User Persona ~ Maria #1 ]----------------------

# Produce all known care tasks
@nurse.route('/care-tasks', methods=['GET'])
def get_caretasks():
...
@nurse.route('/care-tasks/', methods=['POST'])
...
@nurse.route('/care-tasks/{task_id}', methods=['GET'])
...
@nurse.route('/patient-symptom-records', methods=['GET'])
...
@nurse.route('/patient-symptom-records', methods=['POST'])
...
@nurse.route('/patient-symptom-records', methods=['UPDATE'])
...
@nurse.route('/lab-results', methods=['GET'])
def get_lab_results():
    cursor = db.get_db().cursor()
...
@nurse.route('/lab-results', methods=['PUT'])
...
@nurse.route('/medication-administration', methods=['GET'])
...
@nurse.route('/medication-administration', methods=['POST'])
...
@nurse.route('/care-pathways', methods=['GET'])
...
@nurse.route('/patient-pathway-records', methods=['POST'])
