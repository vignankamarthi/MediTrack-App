...
def create_app():
    ...
    app.register_blueprint(admins,    url_prefix='/system_admin')
    app.register_blueprint(pharmacists,    url_prefix='/pharmacist')
    app.register_blueprint(physicians,    url_prefix='/physician')
