...
from backend.physican.physican_route import physician
...
def create_app():
    ...
    app.config['MYSQL_DATABASE_PORT'] = int(os.getenv('DB_PORT', 3307))
    ...
    app.register_blueprint(pharmacist,    url_prefix='/pharmacist')
